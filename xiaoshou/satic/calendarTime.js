...
function Calendar(beginYear, endYear, lang, dateFormatStyle) {
	...
	this.container = this.getElementById("ContainerPanel");   //控制关闭模态框
	this.form = null;
...
Calendar.prototype.draw = function() {
	...
	mvAry[mvAry.length] = '        <th align="left" width="1%"><input style="border: 1px solid '
			...
			+ ';width:16px;height:26px;" name="prevMonth" type="button" id="prevMonth" value="<" /></th>';
	mvAry[mvAry.length] = '        <th align="center" width="98%" nowrap="nowrap"><select name="calendarYear" id="calendarYear" style="font-size:12px;width:70px;height: 100%;margin-bottom: 0px;"></select><select name="calendarMonth" id="calendarMonth" style="font-size:12px;width:70px;height: 100%;margin-bottom: 0px;"></select></th>';
	mvAry[mvAry.length] = '        <th align="right" width="1%"><input style="border: 1px solid '
			+ calendar.colors["input_border"]
			+ ';background-color:'
			+ calendar.colors["input_bg"]
			+ ';width:16px;height:26px;" name="nextMonth" type="button" id="nextMonth" value=">" /></th>';
	mvAry[mvAry.length] = '      </tr>';
	...
	mvAry[mvAry.length] = '        <td colspan="6"><select name="calendarHour" id="calendarHour" style="width: 31%;height:100%;padding:0;margin-bottom:0;"></select>';
	mvAry[mvAry.length] = ':<select name="calendarMinute" id="calendarMinute" style="width: 31%;height:100%;padding:0;margin-bottom:0;"></select>';
	mvAry[mvAry.length] = ':<select name="calendarSecond" id="calendarSecond" style="width: 31%;height:100%;padding:0;margin-bottom:0;"></select>';
	...
	$("#calendarHour option:first").attr("selected", 'selected'); 
...
Calendar.prototype.onblur = function() {
	if (!isFocus) {
		$("#calendarHour option:first").prop("selected", 'selected');
